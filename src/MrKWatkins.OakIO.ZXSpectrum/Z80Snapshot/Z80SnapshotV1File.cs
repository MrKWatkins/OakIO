...
public sealed class Z80SnapshotV1File : Z80SnapshotFile<Z80SnapshotV1Header>
{
    private readonly byte[] compressedData;

    internal Z80SnapshotV1File(Z80SnapshotV1Header header, byte[] compressedData) : base(header)
    {
        this.compressedData = compressedData;
    }

    [Pure]
    public static Z80SnapshotV1File Create48k(Span<byte> memory, bool compress = true)
    {
        var header = new Z80SnapshotV1Header { DataIsCompressed = compress };
