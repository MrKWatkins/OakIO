...
public sealed class Z80SnapshotFormatTests : ZXSpectrumTestFixture
{
    ...
    {
        var header = new Z80SnapshotV1Header
        {
            Registers =
            {
                PC = 0
        ...
        var snapshot = new Z80SnapshotV1File(header, new byte[16384]);

        using var memoryStream = new MemoryStream();
        // ReSharper disable once AccessToDisposedClosure
        Z80SnapshotFormat.Instance.Invoking(f => f.Write(snapshot, memoryStream))
    ...
    public void Read_V1(string resource, bool expectedDataIsCompressed)
    {
        ...
        var file = Z80SnapshotFormat.Instance.Read(monty);
        file.Format.Should().BeTheSameInstanceAs(Z80SnapshotFormat.Instance);

        var v1File = file.Should().BeOfType<Z80SnapshotV1File>().Value;
    ...
    public void Read_V2()
    {
        ...
        var v2File = file.Should().BeOfType<Z80SnapshotV2File>().Value;
        AssertMontyV2OrV3<Z80SnapshotV2File, Z80SnapshotV2Header>(v2File);
    }
    ...
    public void Read_V2_bytes()
    {
        ...
        var file = Z80SnapshotFormat.Instance.Read(bytes);
        file.Format.Should().BeTheSameInstanceAs(Z80SnapshotFormat.Instance);
    ...
    public void Read_V3()
    {
        ...
        var v3File = file.Should().BeOfType<Z80SnapshotV3File>().Value;
        AssertMontyV2OrV3<Z80SnapshotV3File, Z80SnapshotV3Header>(v3File);
    }

    private static void AssertMontyV1(Z80SnapshotFile file)
    {
    ...
    private static void AssertMontyV2OrV3<TFile, THeader>(TFile v2OrV3File)
        where TFile : Z80SnapshotV2OrV3File<THeader>
    ...
    public void RoundTrip(string resource)
    {
        ...
        var actual = Z80SnapshotFormat.Instance.Write(file);
    ...
    public void Read_UnsupportedExtraLength()
    {
        ...
        AssertThat.Invoking(() => Z80SnapshotFormat.Instance.Read(stream))
            .Should().Throw<InvalidOperationException>()
    ...
    public void Write_ThrowsForWrongFileType()
    {
        ...
        AssertThat.Invoking(() => Z80SnapshotFormat.Instance.Write(tapFile, output))
