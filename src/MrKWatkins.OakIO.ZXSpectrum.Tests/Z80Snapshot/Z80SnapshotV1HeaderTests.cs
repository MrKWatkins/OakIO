...
public sealed class Z80SnapshotV1HeaderTests
{
    [Test]
    ...
    public void BorderColour([Values] ZXColour colour)
    {
        ...
        var header = new Z80SnapshotV1Header(bytes);
    ...
    public void Joystick([Values] Joystick joystick)
    {
        ...
        header.Joystick.Should().Equal(MrKWatkins.OakIO.ZXSpectrum.Z80Snapshot.Joystick.Cursor);
