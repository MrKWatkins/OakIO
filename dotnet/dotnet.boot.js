export const config = {
  ...
  "resources": {
    ...
    "assembly": [
      {
        "name": "MrKWatkins.BinaryPrimitives.dll",
        "virtualPath": "MrKWatkins.BinaryPrimitives.dll"
      },
      {
        "name": "MrKWatkins.OakIO.Commands.dll",
        "virtualPath": "MrKWatkins.OakIO.Commands.dll"
      },
      {
        "name": "MrKWatkins.OakIO.Wasm.dll",
        "virtualPath": "MrKWatkins.OakIO.Wasm.dll"
      },
      {
        "name": "MrKWatkins.OakIO.ZXSpectrum.dll",
        "virtualPath": "MrKWatkins.OakIO.ZXSpectrum.dll"
      },
      {
        "name": "MrKWatkins.OakIO.dll",
        "virtualPath": "MrKWatkins.OakIO.dll"
      },
      {
